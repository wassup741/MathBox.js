...
typeof d+")";case "function":return function(){return c(a.apply(this,arguments),d.apply(this,arguments))};case "boolean":return.5<h?d:a;case "number":return b(a,d);case "object":if(!a)return d;if(!d)return a;if(Array.isArray(d))return f=[],_.loop(a.length,function(b){f[b]=c(a[b],d[b])}),f;if(d.constructor==THREE.Matrix4){f=new THREE.Matrix4;for(var k=0;16>k;++k)f.elements[k]=b(a.elements[k],d.elements[k]);return f}return d.constructor==THREE.Vector3?(f=new THREE.Vector3,f.x=b(a.x,d.x),f.y=b(a.y,d.y),
f.z=b(a.z,d.z),f):d.constructor==THREE.Color?(f=new THREE.Color,f.r=b(a.r,d.r),f.g=b(a.g,d.g),f.b=b(a.b,d.b),f):.5<h?d:a}}this.start||this.init(a);var e=this.object;a=this.from;var d=this.to,g=this.key,k=this.ease,h;this.fraction=h=0<this.duration?Math.min(1,(MathBox.Animator.now-this.start)/(this.duration||1)):1;var f;switch(k){case "in":f=1-(1-h)*(1-h);break;case "out":f=h*h;break;case "linear":f=h;break;default:f=.5-.5*Math.cos(h*\u03c0)}a=c(a,d);this.object.set(this.key,a,!0)},hurry:function(a){this.duration=
...
MathBox.Ticks=function(a,b,c,e,d,g,k){var h=(b-a)/(c||10);e=e||1;d=d||10;var f=e*((k||0)+Math.pow(d,Math.floor(Math.log(h/e)/Math.log(d))));c=_.map(0==d%2?[d/2,1,.5]:[1],function(a){return f*a});var l=_.reduce(c,function(a,b){return Math.abs(b-h)<Math.abs(a-h)?b:a},f);g=+!g;a=(Math.ceil(a/l)+g)*l;b=(Math.floor(b/l)-g)*l;c=Math.ceil((b-a)/l)+1;var m=[];_.loop(c,function(b){m.push(a+b*l)});return m};MathBox.TicksLog=function(a,b,c,e,d,g){};
...
[],b)if("style"==e)for(j in b.style)c.push(j);else c.push(e);return c}var c=[],e,d={};a.forEach(function(a){var c=a[0],e=a[1]||"",g=a[2]||{},k=a[3]||{};if("set"==c)return null;"add"==c&&(e=g.sequence);"remove"==c&&(k=g);b(a).forEach(function(a){a=[e,a].join(".");d[a]||(d[a]=[]);k=k||{};d[a].push((k.delay||0)+(k.duration||0)+(k.hold||0))})});var g=0;for(e in d)var k=d[e]=d[e].reduce(function(a,b){return a+b}),g=Math.max(g,k);a.forEach(function(a){var e=a[0],k=a[1]||"",m=a[2]||{},n=a[3]||{},u;if("set"==
e)return c.push(a);"add"==e&&(u=k,k=m.sequence);"remove"==e&&(n=m);b(a).forEach(function(a){var b=[k,a].join("."),h=n.delay||0,v=n.duration||0,w=n.hold||0;void 0!==d[b]&&(h+=g-d[b],delete d[b]);n={delay:h,duration:v,hold:w};"add"==e&&c.push([e,u,m,n]);"remove"==e?c.push([e,k,n]):(b={},b[a]=m.style&&void 0!==m.style[a]?m.style[a]:m[a],c.push([e,k,b,n]))})});return c},apply:function(a,b,c,e){var d=this._stage;_.each(a,function(a){var k=a[0]||"",h=a[1]||"",f=a[2]||{},l=a[3]||{};"remove"==k&&(l=f);b&&
(a=this.invert(a),a=[0,0].concat(a),Array.prototype.splice.apply(b,a));e&&l&&(l=_.extend({},l),l.delay/=2,l.duration/=2,l.hold/=2);c&&(l={delay:0,duration:0,hold:0},"animate"==k&&(k="set"));switch(k){case "clone":d.clone(h,f,l);break;case "add":d.spawn(h,f,l);break;case "remove":_.each(d.select(h),function(a){d.remove(a,l)});break;case "set":var k=d.select(h),m=Array.isArray(f);_.each(k,function(a,b){d.set(a,m?f[b]:f)});break;case "animate":k=d.select(h),m=Array.isArray(f),_.each(k,function(a,b){d.animate(a,
m?f[b]:f,l)})}}.bind(this));return this},insert:function(a){a[0].constructor!=Array&&(a=[a]);this.script.splice(this.step,0,a);this.forward();return this},is:function(a){if(!this.script.length)return!1;for(;0>a;)a+=this.script.length+1;for(;a>=this.script.length+1;)a-=this.script.length+1;return a==this.step},isFirst:function(){return this.is(0)},isLast:function(){return this.is(-1)},go:function(a,b){if(this.script.length){for(;0>a;)a+=this.script.length+1;for(;a>=this.script.length+1;)a-=this.script.length+
1;for(;a>this.step;)this.forward(b);for(;a<this.step;)this.back(b)}},skipping:function(){var a=+new Date,b=!1;500>a-this.lastCommand&&(b=!0);this.stage().hurry("*");this.lastCommand=a;return b},forward:function(a,b){if(!(this.step>=this.script.length)){var c=this.step,e=this.script[c],d=this.rollback[c]=[];this.step++;var g=function(){this.apply(e,d,a,a?!1:this.skipping());this.rollback[c]=this.invertDelay(d);this.clock(c+1,!0);this.emit("go",c+1,1)}.bind(this);b?setTimeout(g,+b):g();return this}},
back:function(a,b){if(!(0>=this.step)){this.step--;var c=this.step,e=this.rollback[c],d=function(){this.apply(e,null,a||this.skipping());delete this.rollback[c];this.emit("go",c,-1)}.bind(this);b?setTimeout(d,+b):d();return this}},stage:function(){return this._stage}};_.each(MathBox.Stage.prototype,function(a,b){MathBox.Director.prototype[b]||(MathBox.Director.prototype[b]=function(){var b=this.stage[a].apply(this.stage,arguments);return b===this.stage?this:b})});MicroEvent.mixin(MathBox.Director);
MathBox.Style=function(a){var b=this.defaults();a=_.extend(b,a||{});this.set(a)};
MathBox.Style.prototype={defaults:function(){return{color:new THREE.Color(3178736),opacity:1,lineWidth:2,pointSize:5,mathScale:new THREE.Vector3(1,1,1),mathRotation:new THREE.Vector3,mathPosition:new THREE.Vector3,worldScale:new THREE.Vector3(1,1,1),worldRotation:new THREE.Vector3,worldPosition:new THREE.Vector3,zIndex:0,map:null,mapColor:0,mapOpacity:0}},validateColor:function(a){if(Array.isArray(a)){a=a.concat([0,0,0]);var b=new THREE.Color;return b.setRGB.apply(b,a)}return a.constructor==Number?
new THREE.Color(a):a.constructor!=THREE.Color?this.get("color"):a},validateMathScale:function(a){if(Array.isArray(a)){a=a.concat([1,1,1]);var b=new THREE.Vector3;return b.set.apply(b,a)}return a.constructor!=THREE.Vector3?this.get("mathScale"):a},validateMathRotation:function(a){if(Array.isArray(a)){a=a.concat([0,0,0]);var b=new THREE.Vector3;return b.set.apply(b,a)}return a.constructor!=THREE.Vector3?this.get("mathRotation"):a},validateMathPosition:function(a){if(Array.isArray(a)){a=a.concat([0,
0,0]);var b=new THREE.Vector3;return b.set.apply(b,a)}return a.constructor!=THREE.Vector3?this.get("mathPosition"):a},validateWorldScale:function(a){if(Array.isArray(a)){a=a.concat([1,1,1]);var b=new THREE.Vector3;return b.set.apply(b,a)}return a.constructor!=THREE.Vector3?this.get("worldScale"):a},validateWorldRotation:function(a){if(Array.isArray(a)){a=a.concat([0,0,0]);var b=new THREE.Vector3;return b.set.apply(b,a)}return a.constructor!=THREE.Vector3?this.get("worldRotation"):a},validateWorldPosition:function(a){if(Array.isArray(a)){a=
a.concat([0,0,0]);var b=new THREE.Vector3;return b.set.apply(b,a)}return a.constructor!=THREE.Vector3?this.get("worldPosition"):a}};MathBox.Attributes.mixin(MathBox.Style);
...
n=c.tickScale,c=c.decimals,u=this.points,t=this.labelPoints,r=this.labelTangent,q=this.tickPoints,v=this.tickSigns,w=[0,0,0],y=new THREE.Vector3;new THREE.Vector4;var x=a.axis(e),z=x[0],x=x[1],B=(x-z)/(f-1);y.set.apply(y,d);_.loop(f,function(a){w[e]=z+a*B;u[a].set.apply(u[a],w);u[a].addSelf(y)});this.line.show(k);this.arrow.show(g);f=this.scale=MathBox.Ticks(z,x,l,m,n,!0);this.ticks.show(!!l);if(l){l=Math.floor(q.length/2);f.length>l&&(f=f.slice(0,l));var l=[0,0,0],A;l[2==e?0:1-e]=.01*(x-z);this.epsilon.set.apply(this.epsilon,
l);w=[0,0,0];_.each(f,function(a,b){w[e]=a;var c=2*b;q[c].set.apply(q[c],w);q[c].addSelf(y);v[c]=1;q[c+1].copy(q[c]);v[c+1]=-1;t[b].copy(q[c]);A=c+1});l=A+1;for(f=q.length;l<f;)q[l].copy(q[A]),v[l]=v[A],l++}w=[0,0,0];w[e]=1;r.set.apply(r,w);this.labels.show(!!h);this.labels.set("decimals",c)},make:function(){var a=this.get(),b=a.n,c=a.size,e=a.ticks,d=a.distance,g=a.formatter,k=this.style,h=this.points=[],f=this.labelPoints=[],l=this.labelTangent=new THREE.Vector3,m=this.tickPoints=[],n=this.tickSigns=
[],u=this.epsilon=new THREE.Vector3;_.loop(b,function(a){h.push(new THREE.Vector3)});_.loop(4*e,function(a){f.push(new THREE.Vector3)});_.loop(8*e,function(a){m.push(new THREE.Vector3);n.push(1)});var e={dynamic:!0,size:c,offset:.5},c={dynamic:!0,size:.2*c},d={dynamic:!0,distance:d},t=function(b){b=this.scale[b];return 0!=b||a.zero?g?g(b):b:""}.bind(this);this.line=new MathBox.Renderable.Mesh(h,{dynamic:!0,type:"line"},k);this.arrow=new MathBox.Renderable.ArrowHead(h[b-2],h[b-1],e,k);this.ticks=new MathBox.Renderable.Ticks(m,
n,u,c,k);this.labels=new MathBox.Renderable.Labels(f,l,t,d,k)}});MathBox.Axis.validateArgs=function(a){"number"==typeof a&&(a={axis:a});return a};MathBox.Primitive.types.axis=MathBox.Axis;MathBox.Grid=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
MathBox.Vector.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{n:1,data:null,arrow:!0,expression:function(){return 0},live:!0,style:{},size:.07}},type:function(){return"vector"},renderables:function(){return this.render},adjust:function(a){var b=this.get();0<this.style.get("opacity")&&(b.arrow||b.live)&&this.calculate(a);_.each(this.arrows,function(a){a.show(b.arrow)})},make:function(){var a=this.get(),b=a.arrow,c=this.style,e=a.n,d=this.vertices=[],g=this.points=[],k=this.render=
[],h=this.arrows=[],f={dynamic:a.live,type:"line",strip:!1},l={size:a.size},m=0;_.loop(e,function(){d.push(new THREE.Vector3);d.push(new THREE.Vector3);g.push(new THREE.Vector3);g.push(new THREE.Vector3);if(b){var a=new MathBox.Renderable.ArrowHead(g[m++],g[m++],l,c);k.push(a);h.push(a)}});this.line=new MathBox.Renderable.Mesh(d,f,c);k.push(this.line);this.calculate()},calculate:function(a){var b=this.vertices,c=this.arrows,e=this.points,d=this.get(),g=d.data,k=d.arrow,h=d.n,f=d.size,l=this.style.get("mathScale"),
m=0,n=0;_.loop(2*h,function(h){p=g&&void 0!==g[h]?g[h]:d.expression.call(this,n,m);var t=0,r=0,q=0;if(Array.isArray(p)){var v=p.length;0<v&&(t=p[0]);1<v&&(r=p[1]);2<v&&(q=p[2])}else t=h,r=+p,q=0;e[h].set(t,r,q);b[h].set(t,r,q);a&&k&&1==h%2&&(t=MathBox.Vector.vLast,r=MathBox.Vector.vCurrent,r.copy(b[h]),t.copy(b[h-1]),a.to(r),a.to(t),r.subSelf(t).multiplySelf(l),v=r.length(),q=Math.min(1,.5*v/f),q=(1-(1-q)*(1-q))*f,v-=q,r.normalize().multiplyScalar(v).divideSelf(l).addSelf(t),a.from(r),b[h].copy(r),
...
{type:"points",dynamic:a.live},b);if(a.shaded){var d=this.tangents=[[],[]];_.loop(c[0]*c[1],function(){d[0].push(new THREE.Vector3);d[1].push(new THREE.Vector3)})}this.calculate()},calculate:function(){var a=this.vertices,b=this.tangents,c=this.get(),e=c.data,d=c.domain,g=c.n,k=c.flipSided,h=k?1:0,k=k?0:1;"number"==typeof g&&(g=[g,g]);var f=d[0][0],l=d[1][0],m=(d[0][1]-f)/(g[0]-1),n=(d[1][1]-l)/(g[1]-1),u,t=0;_.loop(g[1],function(b){f=d[0][0];_.loop(g[0],function(d){u=e&&void 0!==e[b]&&void 0!==e[b][d]?
e[b][d]:c.expression.call(this,f,l,d,b,t);var g=d=0,h=0;if(Array.isArray(u)){var k=u.length;0<k&&(d=u[0]);1<k&&(g=u[1]);2<k&&(h=u[2])}else d=f,g=+u,h=l;a[t].set(d,g,h);f+=m;t++}.bind(this));l+=n}.bind(this));if(c.shaded){var t=0,l=d[1][0],r=g[0];_.loop(g[1],function(c){f=d[0][0];var e=c?c-1:0,h=Math.min(g[1]-1,c+1);_.loop(g[0],function(d){var k=d?d-1:0,l=Math.min(g[0]-1,d+1),n=a[d+c*r];l==d?b[0][t].sub(n,a[k+c*r]).addSelf(n):b[0][t].copy(a[l+c*r]);h==c?b[1][t].sub(n,a[d+e*r]).addSelf(n):b[1][t].copy(a[d+
...
m)/(k[0]-1),t=(c[1][1]-n)/(k[1]-1),r=0;_.loop(k[1],function(b){m=c[0][0];_.loop(k[0],function(b){a[r].set(m,n,0);m+=u;r++}.bind(this));n+=t}.bind(this));l={uniforms:l,shaders:{position:function(a,b){g?(a.snippet("bezierSurface"+d),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+d).snippet("mathTransform"),b.viewport(a))}}};this.mesh.set(l);this.line.set(l);
...
MathBox.Label.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{position:null,facing:1,distance:15,expression:function(){return 0},style:{color:new THREE.Color(7368816)},className:"mathbox-label",text:""}},renderables:function(){return[this.labels]},type:function(){return"label"},adjust:function(a,b){var c=this.get(),e=[0,0,0];e[c.facing]=1;var d=this.labelTangent;d.set.apply(d,e);e=c.position;d=this.labelPoint;e?d.set.apply(d,e):d.set.apply(d,c.expression.call(this));this.labels.show(!0)},
make:function(){var a=this.get(),b=a.position,c=a.text,e=a.distance,d=a.className,g=this.style,k=this.labelTangent=new THREE.Vector3,h=this.labelPoint=new THREE.Vector3,e={dynamic:!0,distance:e,className:d};b?h.set.apply(h,b):h.set.apply(h,a.expression.call(this));a=function(a){return c}.bind(this);this.labels=new MathBox.Renderable.Labels([h],k,a,e,g)}});MathBox.Label.validateArgs=function(a){return a};MathBox.Primitive.types.label=MathBox.Label;
...
MathBox.Renderable.Labels.prototype=_.extend(new MathBox.Renderable(null),{defaults:function(){return{absolute:!0,distance:15,size:1,className:"mathbox-label"}},make:function(a){a=this.get();var b=this.tangent,c=this.sprites,e=a.className;a=this.points.length;this._anchor=new THREE.Vector3;var d=document.createElement("div"),g=this.object=new MathBox.Sprite(d);d.className="mathbox-labels";_.loop(a,function(a){a=document.createElement("div");var d=document.createElement("div");a.appendChild(d);var f=
new MathBox.Sprite(a,b);a.className=e;d.className="mathbox-wrap";d.style.position="relative";d.style.display="inline-block";d.style.left="-50%";d.style.top="-.5em";c.push(f);g.add(f)})},adjust:function(a,b,c,e,d){var g=this.get(),k=this.points;b=this.sprites;var h=this.callback,f=g.decimals,l=this.style.get("opacity"),m=window.MathJax&&MathJax.Hub,n=1/Math.log(10);_.each(b,function(b,c){b.position.copy(k[c]);a.to(b.position);d.matrix.multiplyVector3(b.position);b.distance=g.distance;b.opacity=l;var e=
"";if(h){e=h(c);void 0===e&&(e="");if(+e==e){var q=+e;if(0!=q)var e=0>q?-1:1,q=Math.abs(q),v=Math.pow(10,f-1-Math.floor(Math.log(q)*n)),e=q=e*Math.round(v*q)/v}m||(e=(""+e).replace(/^-/,"\u2013"))}b.content!==e&&(q=b.element.children[0],b.content=e,b.measure=!0,m?(q.innerHTML="\\("+e+"\\)",MathJax.Hub.queue.Push(["Typeset",MathJax.Hub,q])):q.innerHTML=e)});MathBox.Renderable.prototype.adjust.call(this,a)}});
...
MathBox.Viewport.prototype={defaults:function(){return{type:"none",rotation:[0,0,0],position:[0,0,0]}},uniforms:function(){return this._uniforms},axis:function(a){return[0,1]},to:function(a){},from:function(a){},update:function(a){var b=this.get();_.each(["position","rotation"],function(c){a[c].set.apply(a[c],b[c])})},shader:function(a){a.snippet("mathToWorld")},validateRotation:function(a){return Array.isArray(a)?(a=a.concat([0,0,0]),a.slice(0,3)):this.get("rotation")},validatePosition:function(a){return Array.isArray(a)?
(a=a.concat([0,0,0]),a.slice(0,3)):this.get("position")}};MathBox.Attributes.mixin(MathBox.Viewport,"type");MathBox.Viewport.types={};MathBox.Viewport.make=function(a){return new (MathBox.Viewport.types[a.type]||MathBox.Viewport.types.cartesian||MathBox.Viewport)(a)};
...
a);min=b[0];max=b[1];alpha=this._uniforms.polarAlpha;aspect=this._uniforms.polarAspect;focus=this._uniforms.polarFocus;1==a&&0<alpha&&(max=Math.max(Math.abs(max),Math.abs(min)),min=Math.max(-focus/aspect+.001,min));return[min,max]},update:function(a){var b=this.get(),c=b.range,e=b.scale,d=b.polar,g=b.fold,k=b.power,b=b.helix,h=1,f=c[0][0],l=c[1][0],m=c[2][0],n=c[0][1]-f,u=c[1][1]-l,c=c[2][1]-m,t=e[0],r=e[1],e=e[2],h=0<n?1:-1,q=Math.abs(u),q=n+(q*h-n)*d,h=Math.abs(q/t/(u/r)),v=[q/(2*t),0,0,f+n/2,0,
u/(2*r),0,l+u/2,0,0,c/(2*e),m+c/2,0,0,0,1];this.transform.set.apply(this.transform,[2*t/q,0,0,-(2*f+n)*t/n,0,2*r/u,0,-(2*l+u)*r/u,0,0,2*e/c,-(2*m+c)*e/c,0,0,0,1]);this.inverse.set.apply(this.inverse,v);this._uniforms.polarAlpha=d;this._uniforms.polarAspect=h;this._uniforms.polarFold=g;this._uniforms.polarPower=k;this._uniforms.polarFocus=0<d?1/d-1:0;this._uniforms.polarHelix=b;MathBox.Viewport.prototype.update.call(this,a)},shader:function(a){a.snippet("polarPower").snippet("cartesianToPolar").snippet("mathToWorld")},
...
c=this.get("projective");b.set.apply(b,c[0].concat(c[1],c[2],c[3]));this._uniforms.projectiveInverse.getInverse(b);MathBox.ViewportCartesian.prototype.update.call(this,a)},shader:function(a){a.snippet("projectiveTransform").snippet("mathToWorld")},validateProjective:function(a){if(Array.isArray(a)){for(var b=0;3>b;++b)a[b]=a[b]&&a.constructor==Array&&a[b]||[],a[b]=a[b].concat([0,0,0,0]).slice(0,4);return a}}});MathBox.Attributes.mixin(MathBox.Viewport);MathBox.Viewport.types.projective=MathBox.ViewportProjective;
